...
const treinamentosTurmaRoutes = require("./routes/treinamentos-turma.routes");
const certificadosTreinamentoRoutes = require("./routes/certificados-treinamento.routes");
...
app.use("/api/rh/treinamentos", authMiddleware, treinamentosTurmaRoutes);
app.use("/api/rh/certificados", authMiddleware, certificadosTreinamentoRoutes);
